                        ...
                        <View >
                            <View style={{ width: '100%', flexDirection: 'row' }}>
                                ...
                                < View style={{ alignSelf: 'center', borderBottomWidth: RFValue(0.5), borderBottomColor: DefaultStyles.colors.tabBar, height: height * 0.06, justifyContent: 'center', alignItems: 'center', width: '60%' }}>
                                    {/* <Text style={style.textSummary}>asd</Text> */}
                                    <Text style={style.textSummary}>{carsThisUser[changeCar]?.vehicle?.linkingObjects('Models', 'vehicles')[0].model}</Text>
                                    <Text style={[style.textSummary, { fontSize: RFValue(16), paddingBottom: RFValue(5) }]}>Gastos do mês: R${expensesFirstGraph[1]?.y.toFixed(2)}</Text>
                            ...
                            <View style={{ alignItems: 'center', flexDirection: 'row', justifyContent: 'center', marginTop: RFValue(10), }}>
                                ...
                                <Text style={{ fontSize: RFValue(17), color: DefaultStyles.colors.tabBar, }}>km</Text>
                            </View>
                            ...
                            <View style={{ alignItems: 'center', flexDirection: 'row', justifyContent: 'center', }}>
                                ...
                                <Text style={{ fontSize: RFValue(17), color: DefaultStyles.colors.tabBar, }}>oleo km</Text>
                            </View>
