        ...
        <View style={{ flex: 1 }}>
            <Modal
                ...
                onRequestClose={() => {
                    ...
                    navigator.navigate('ViewExpense')
                }}
            >
                <View style={{ flex: 1, backgroundColor: 'black' }}>
                    ...
                    >
                        ...
                        <TouchableWithoutFeedback onPress={() => {  //Documento
                            ...
                            navigator.navigate('DocumentationExpense')
                        }}>
                        ...
                        <TouchableWithoutFeedback onPress={() => {  //Outros
                            setVisibleModal(false)
                            navigator.navigate('MechanicExpense')
                        ...
                        <TouchableWithoutFeedback onPress={() => {
                            setVisibleModal(false)
                            navigator.navigate('FuelExpense')
                        ...
                        <TouchableWithoutFeedback onPress={() => {
                            setVisibleModal(false)
                            navigator.navigate('TyreExpense')
                        ...
                        <TouchableWithoutFeedback onPress={() => {
                            setVisibleModal(false)
                            navigator.navigate('AppearanceExpense')
                        ...
                        <TouchableWithoutFeedback onPress={() => {  //Outros
                            setVisibleModal(false)
                            navigator.navigate('OthersExpense')
